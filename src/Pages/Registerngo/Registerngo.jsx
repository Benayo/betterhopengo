  ...
  return (
    <div className="Registerngo">
      ...
      <div className="greenfields">
        ...
        <p>
          Kindly enter correct infomation about <br /> your NGO/Foundation, you
          will recieve on email <br /> and get onboarded when verified
        </p>
      </div>
      ...
      <div className="lemongreenfields">
        <div className="cashtranss">
          ...
          <div className="third sim">
            ...
            <input type="email" placeholder="enter NGO email address" />
          </div>
